...
system_prompt = """
Пользователь вводит слово. Твоя задача сказать, указывает ли это слово на мат, оскорбление, грязь или вульгарный смысл, который стоит скрыть от детей. Ответ должен быть в формате JSON с полями "question" (исходное слово) и "answer" (1 - если слово плохое, 0 - если нормальное).
